...
class user:
    ...
    def __init__(self, email , password, user_id, is_admin, is_banned,logo_path,citate,time_of_join, db, token):
        ...
        self.citate = citate
        self.token = token
        db.excute_query(f"INSERT INTO user VALUES ('{email}', '{password}', '{user_id}', 0, 0, '{logo_path}', '{citate}', '{str(get_current_time())}', '{token}') ")
